...
public class TestIHM {
	public static void main(String[] args) {
		...
		try {
			LecteurDonnees.lire("cartes/carteSujet.txt",carte,tab_incen,tab_robot);
			
		} catch (FileNotFoundException e) {
			System.out.println("fichier " + "carteSujet.txt" + " inconnu ou illisible");
		} catch (ExceptionFormatDonnees e) {
			System.out.println("\n\t**format du fichier " + "carteSujet.txt" + " invalide: " + e.getMessage());
		}
		
		
		Simulateur invaders = new Simulateur(8,8,carte);
	}
}
